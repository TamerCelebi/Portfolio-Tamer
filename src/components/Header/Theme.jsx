    ...
    <div className="flex justify-center items-center gap-1">
      ...
      >
        ...
        <span
          ...
          aria-hidden="true"
        ></span>
        <span className="absolute w-1.5 h-1.5 sm:w-2 sm:h-2 md:w-2.5 md:h-2.5 left-1 bottom-0.5 bg-[rgb(255,232,110)] transition-all duration-400 ease-in-out transform peer-checked:translate-x-3 rounded-full"></span>
      </label>
